...
this.p2pml.hlsjs = (function (exports) {
    ...
    */
    ...
    var AbortSignalPolyfill = /** @class */ (function () {
        ...
        AbortSignalPolyfill.prototype.dispatchEvent = function (_type) {
            this.aborted = true;
            for (var _i = 0, _a = _classPrivateFieldGet2(_listeners, this); _i < _a.length; _i++) {
                var listener = _a[_i];
                try {
                    listener();
                }
    ...
    var HttpRequestExecutor = /** @class */ (function () {
        ...
        HttpRequestExecutor.prototype.fetch = function (requestControls) {
            ...
            return _asyncToGenerator(function () {
                var segment, activeReader, onAbort, abortSignal, _this$httpConfig$http, _this$httpConfig, request, headers, _this$requestByteRang2, requestOptions, response, arrayBuffer, value, reader, _a, done, value, isValid, error_1;
                        ...
                        case 2:
                            ...
                            if (!request) {
                                ...
                                if (_this.requestByteRange) {
                                    headers.set("Range", "bytes=".concat(_this.requestByteRange.start, "-").concat((_this$requestByteRang2 = _this.requestByteRange.end) !== null && _this$requestByteRang2 !== void 0 ? _this$requestByteRang2 : ""));
                                }
    ...
    function parseContentRangeHeader(headerValue) {
        ...
        if (!match)
            return;
        var from = match[1], to = match[2], total = match[3];
        return {
    ...
    var require_common = /* @__PURE__ */ __commonJSMin((function (exports, module) {
        ...
        */
        function setup(env) {
            ...
            */
            function disable() {
                var namespaces = __spreadArray(__spreadArray([], createDebug.names, true), createDebug.skips.map(function (namespace) { return "-" + namespace; }), true).join(",");
                createDebug.enable("");
                return namespaces;
            }
            /**
            ...
            */
            function enabled(name) {
                for (var _i = 0, _a = createDebug.skips; _i < _a.length; _i++) {
                    var skip = _a[_i];
                    if (matchesTemplate(name, skip))
                        return false;
                }
                for (var _b = 0, _c = createDebug.names; _b < _c.length; _b++) {
                    var ns = _c[_b];
    ...
    function serializeInt(num) {
        ...
        return new Uint8Array(__spreadArray([numberMetadata], numBytes, true));
    }
    ...
    function serializeSimilarIntArray(numbers) {
        ...
        for (var _a = 0, commonPartNumbersMap_1 = commonPartNumbersMap; _a < commonPartNumbersMap_1.length; _a++) {
            var _b = commonPartNumbersMap_1[_a], commonPart = _b[0], binaryArray = _b[1];
    ...
    function deserializeSimilarIntArray(bytes) {
        if (bytes.length < 2)
            throw new Error("Buffer is too short");
        var codeByte = bytes[0], commonPartArraysAmount = bytes[1];
        ...
        for (var i = 0; i < commonPartArraysAmount; i++) {
            var _a = deserializeInt(bytes.subarray(offset)), commonPartWithLength = _a.number, byteLength = _a.byteLength;
            offset += byteLength;
    ...
    function deserializeString(bytes) {
        if (bytes.length < 2)
            throw new Error("Buffer is too short");
        var codeByte = bytes[0], lengthByte = bytes[1];
    ...
    var BinaryCommandCreator = /** @class */ (function () {
        ...
        BinaryCommandCreator.prototype.complete = function () {
            ...
            if (Math.ceil(unframedBuffer.length / chunksCount) + commandFramesLength > _classPrivateFieldGet2(_maxChunkLength, this))
                chunksCount++;
            for (var _i = 0, _a = splitBufferToEqualChunks(unframedBuffer, chunksCount); _i < _a.length; _i++) {
                var _b = _a[_i], i = _b[0], chunk = _b[1];
                if (i === 0)
        ...
        while (offset < bytes.length) {
            ...
            switch (getDataTypeFromByte(bytes[offset])) {
                case SerializedItem.Int:
                    {
                        var _a = deserializeInt(bytes.subarray(offset)), number = _a.number, byteLength = _a.byteLength;
                ...
                case SerializedItem.SimilarIntArray:
                    {
                        var _b = deserializeSimilarIntArray(bytes.subarray(offset)), numbers = _b.numbers, byteLength = _b.byteLength;
                ...
                case SerializedItem.String:
                    {
                        var _c = deserializeString(bytes.subarray(offset)), string = _c.string, byteLength = _c.byteLength;
    ...
    var PeerProtocol = /** @class */ (function () {
        ...
        PeerProtocol.prototype.sendCommand = function (command) {
            ...
            try {
                for (var _i = 0, binaryCommandBuffers_1 = binaryCommandBuffers; _i < binaryCommandBuffers_1.length; _i++) {
                    var buffer = binaryCommandBuffers_1[_i];
    ...
    var BandwidthCalculator = /** @class */ (function () {
        function BandwidthCalculator(clearThresholdMs) {
            if (clearThresholdMs === void 0) {
                clearThresholdMs = 2e4;
            }
        ...
        BandwidthCalculator.prototype.getBandwidthLoadingOnly = function (seconds, ignoreThresholdTimestamp) {
            if (ignoreThresholdTimestamp === void 0) {
        ...
        BandwidthCalculator.prototype.clearStale = function () {
            ...
            for (var _i = 0, _a = this.loadingOnlyTimestamps; _i < _a.length; _i++) {
                var timestamp = _a[_i];
        ...
        function Peer(id, channel, closeConnection, eventHandlers, peerConfig, eventTarget) {
            ...
            _classPrivateFieldSet2(_peerProtocol, this, new PeerProtocol(channel, peerConfig, {
                ...
                onCommandReceived: function (command) {
                    return void _classPrivateFieldGet2(_onCommandReceived, _this_1).call(_this_1, command).catch(function (error) {
    ...
    var EventTarget = /** @class */ (function () {
        ...
        EventTarget.prototype.getEventDispatcher = function (eventName) {
            ...
            return function () {
                ...
                for (var _a = 0, definedListeners_1 = definedListeners; _a < definedListeners_1.length; _a++) {
                    var listener = definedListeners_1[_a];
                    try {
                        listener.apply(void 0, args);
                    }
                    catch (_unused2) { }
    ...
    */
    var supportsPromiseWebRTC = (function () {
        try {
    ...
    */
    function safeCreateOffer(pc, options) {
        ...
        return new Promise(function (resolve, reject) {
            try {
                pc.createOffer(function (offer) { return resolve(offer); }, function (err) { return reject(err); }, options);
            }
            catch (err) {
                reject(err);
            }
    ...
    */
    function safeCreateAnswer(pc, options) {
        ...
        return new Promise(function (resolve, reject) {
            try {
                pc.createAnswer(function (answer) { return resolve(answer); }, function (err) { return reject(err); }, options);
            }
            catch (err) {
                reject(err);
            }
    ...
    */
    function safeSetLocalDescription(pc, description) {
        ...
        return new Promise(function (resolve, reject) {
            try {
                pc.setLocalDescription(description, function () { return resolve(); }, function (err) { return reject(err); });
            }
            catch (err) {
                reject(err);
            }
    ...
    */
    function safeSetRemoteDescription(pc, description) {
        ...
        return new Promise(function (resolve, reject) {
            try {
                pc.setRemoteDescription(description, function () { return resolve(); }, function (err) { return reject(err); });
            }
            catch (err) {
                reject(err);
            }
    ...
    function _announce(event) {
        var _this2 = this;
        return _asyncToGenerator(function () {
            var offersCount, results, _i, results_1, result, offers, _a, results_2, result, payload, _b, offers_1, offer;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                    ...
                    case 1:
                        ...
                        try {
                            ...
                            for (_b = 0, offers_1 = offers; _b < offers_1.length; _b++) {
                                offer = offers_1[_b];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, safeCreateOffer(pc)];
                    case 2:
                        offer = _a.sent();
                        _assertClassBrand(_WebTorrentClient_brand, _this3, _throwIfDestroyed).call(_this3);
                        return [4 /*yield*/, safeSetLocalDescription(pc, offer)];
                    case 3:
                        _a.sent();
                        _assertClassBrand(_WebTorrentClient_brand, _this3, _throwIfDestroyed).call(_this3);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, safeSetRemoteDescription(pc, new SessionDescription(offerSdp))];
                    case 2:
                        _a.sent();
                        _assertClassBrand(_WebTorrentClient_brand, _this4, _throwIfDestroyed).call(_this4);
                        return [4 /*yield*/, safeCreateAnswer(pc)];
                    case 3:
                        answer = _a.sent();
                        _assertClassBrand(_WebTorrentClient_brand, _this4, _throwIfDestroyed).call(_this4);
                        return [4 /*yield*/, safeSetLocalDescription(pc, answer)];
                    case 4:
                        _a.sent();
                        _assertClassBrand(_WebTorrentClient_brand, _this4, _throwIfDestroyed).call(_this4);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, safeSetRemoteDescription(pending.connection, new SessionDescription(answerSdp))];
                    case 2:
                        _a.sent();
    ...
    function _cleanupPendingOffers() {
        for (var _i = 0, _a = _classPrivateFieldGet2(_pendingOffers, this); _i < _a.length; _i++) {
            var _b = _a[_i], offerId = _b[0], pending = _b[1];
    ...
    function _cleanupNegotiatingConnections() {
        for (var _i = 0, _a = _classPrivateFieldGet2(_negotiatingConnections, this); _i < _a.length; _i++) {
            var pc = _a[_i];
            pc.close();
        }
    ...
    var WebTorrentManager = /** @class */ (function () {
        ...
        WebTorrentManager.prototype.start = function () {
            ...
            try {
                var _loop_1 = function (url) {
                    var _b = _classPrivateFieldGet2(_config$3, this_1).socketPool.acquire(url), wsClient = _b.client, release = _b.release;
                    var client;
                    try {
                ...
                var this_1 = this;
                for (var _i = 0, _a = _classPrivateFieldGet2(_config$3, this).trackerUrls; _i < _a.length; _i++) {
                    var url = _a[_i];
                    _loop_1(url);
                }
            }
        ...
        WebTorrentManager.prototype.destroy = function () {
            ...
            for (var _i = 0, _a = _classPrivateFieldGet2(_clients, this); _i < _a.length; _i++) {
                var _b = _a[_i], client = _b.client, releaseSocket = _b.releaseSocket, cleanupListeners = _b.cleanupListeners;
                cleanupListeners();
                client.destroy();
                releaseSocket();
            }
            ...
            var connectedSnapshot = __spreadArray([], _classPrivateFieldGet2(_connectedPeers, this).entries(), true);
            _classPrivateFieldGet2(_connectedPeers, this).clear();
            for (var _c = 0, connectedSnapshot_1 = connectedSnapshot; _c < connectedSnapshot_1.length; _c++) {
                var _d = connectedSnapshot_1[_c], peerId = _d[0], peer = _d[1];
                peer.cleanup();
    ...
    */
    ...
    function getSegmentFromStreamsMap(streams, segmentRuntimeId) {
        for (var _i = 0, _a = streams.values(); _i < _a.length; _i++) {
            var stream = _a[_i];
    ...
    function getSegmentFromStreamByExternalId(stream, segmentExternalId) {
        for (var _i = 0, _a = stream.segments.values(); _i < _a.length; _i++) {
            var segment = _a[_i];
    ...
    function getSegmentAvgDuration(stream) {
        ...
        for (var _i = 0, _a = segments.values(); _i < _a.length; _i++) {
            var segment = _a[_i];
    ...
    var P2PLoader = /** @class */ (function () {
        function P2PLoader(streamManifestUrl, stream, requests, segmentStorage, config, webTorrentSocketPool, eventTarget, onSegmentAnnouncement) {
            ...
            _defineProperty(this, "broadcastAnnouncement", function (sendEmptyAnnouncement) {
                if (sendEmptyAnnouncement === void 0) {
                    sendEmptyAnnouncement = false;
                }
            ...
            _classPrivateFieldInitSpec(this, _sendSegmentsAnnouncement, function (sendEmptyAnnouncement) {
                ...
                queueMicrotask(function () {
                    var _a = sendEmptyAnnouncement ? {} : _assertClassBrand(_P2PLoader_brand, _this_1, _getSegmentsAnnouncement).call(_this_1), _b = _a.loaded, loaded = _b === void 0 ? [] : _b, _c = _a.httpLoading, httpLoading = _c === void 0 ? [] : _c;
                    for (var _i = 0, _d = _classPrivateFieldGet2(_peersMap, _this_1).values(); _i < _d.length; _i++) {
                        var peer = _d[_i];
                        peer.sendSegmentsAnnouncementCommand(loaded, httpLoading);
                    }
        ...
        P2PLoader.prototype.downloadSegment = function (segment) {
            ...
            for (var _i = 0, _a = _classPrivateFieldGet2(_peersMap, this).values(); _i < _a.length; _i++) {
                var peer = _a[_i];
            ...
            if (peersWithSegment.length === 1)
                ...
                var maxSpeed = 0;
                for (var _b = 0, peersWithSegment_1 = peersWithSegment; _b < peersWithSegment_1.length; _b++) {
                    var peer = peersWithSegment_1[_b];
                ...
                if (maxSpeed > 0) {
                    ...
                    for (var _c = 0, peersWithSegment_2 = peersWithSegment; _c < peersWithSegment_2.length; _c++) {
                        var peer = peersWithSegment_2[_c];
        ...
        P2PLoader.prototype.peers = function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _i = 0, _a = _classPrivateFieldGet2(_peersMap, this).values();
                        _b.label = 1;
                    case 1:
                        if (!(_i < _a.length))
                            return [3 /*break*/, 4];
    ...
    function _getSegmentsAnnouncement() {
        ...
        var httpLoading = [];
        for (var _i = 0, _a = _classPrivateFieldGet2(_requests$1, this).httpRequests(); _i < _a.length; _i++) {
            var request = _a[_i];
    ...
    var P2PLoadersContainer = /** @class */ (function () {
        ...
        P2PLoadersContainer.prototype.destroy = function () {
            for (var _i = 0, _a = _classPrivateFieldGet2(_loaders, this).values(); _i < _a.length; _i++) {
                var _b = _a[_i], loader = _b.loader, destroyTimeoutId = _b.destroyTimeoutId;
                loader.destroy();
    ...
    var RequestsContainer = /** @class */ (function () {
        ...
        Object.defineProperty(RequestsContainer.prototype, "executingHttpCount", {
            get: function () {
                var count = 0;
                for (var _i = 0, _a = this.httpRequests(); _i < _a.length; _i++) {
                    var request = _a[_i];
        ...
        Object.defineProperty(RequestsContainer.prototype, "executingP2PCount", {
            get: function () {
                var count = 0;
                for (var _i = 0, _a = this.p2pRequests(); _i < _a.length; _i++) {
                    var request = _a[_i];
                    if (request.status === "loading")
                        count++;
                }
        ...
        RequestsContainer.prototype.destroy = function () {
            for (var _i = 0, _a = this.requests.values(); _i < _a.length; _i++) {
                var request = _a[_i];
                if (request.status !== "loading")
                    continue;
    ...
    function generateQueue(lastRequestedSegment, playback, playbackConfig, currentP2PLoader, availablePercentMemory) {
        var runtimeId, stream, requestedSegment, queueSegments, first, next, firstStatuses, next, second, secondStatuses, _i, queueSegments_1, segment, statuses;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 4:
                    ...
                    _a.label = 5;
                case 5:
                    _i = 0, queueSegments_1 = queueSegments;
                    _a.label = 6;
                case 6:
                    if (!(_i < queueSegments_1.length))
                        return [3 /*break*/, 9];
                    segment = queueSegments_1[_i];
    ...
    var HybridLoader = /** @class */ (function () {
        ...
        HybridLoader.prototype.processRequests = function (queueSegmentIds, queueDownloadRatio) {
            ...
            var now = performance.now();
            for (var _i = 0, _a = this.requests.items(); _i < _a.length; _i++) {
                var request = _a[_i];
        ...
        HybridLoader.prototype.processQueue = function () {
            var _this_1 = this;
            var _a = this.generateQueue(), queue = _a.queue, queueSegmentIds = _a.queueSegmentIds, queueDownloadRatio = _a.queueDownloadRatio;
            this.processRequests(queueSegmentIds, queueDownloadRatio);
            var _b = this.config, simultaneousHttpDownloads = _b.simultaneousHttpDownloads, simultaneousP2PDownloads = _b.simultaneousP2PDownloads, httpErrorRetries = _b.httpErrorRetries, httpDownloadInitialTimeoutMs = _b.httpDownloadInitialTimeoutMs;
        ...
        HybridLoader.prototype.loadRandomThroughHttp = function () {
            ...
            if (availableStorageCapacityPercent <= 10)
                return;
            var _a = this.config, simultaneousHttpDownloads = _a.simultaneousHttpDownloads, httpErrorRetries = _a.httpErrorRetries;
            ...
            if (this.requests.executingHttpCount >= simultaneousHttpDownloads || !p2pLoader.connectedPeerCount)
                return;
            var segmentsToLoad = [];
            for (var _i = 0, _b = generateQueue(this.lastRequestedSegment, this.playback, this.config, this.p2pLoaders.currentLoader, availableStorageCapacityPercent); _i < _b.length; _i++) {
                var _c = _b[_i], segment = _c.segment, statuses = _c.statuses;
            ...
            for (var _d = 0, randomIndices_1 = randomIndices; _d < randomIndices_1.length; _d++) {
                var randomIndex = randomIndices_1[_d];
        ...
        HybridLoader.prototype.abortLastHttpLoadingInQueueAfterItem = function (queue, segment) {
            for (var _i = 0, _a = arrayBackwards(queue); _i < _a.length; _i++) {
                var itemSegment = _a[_i].segment;
        ...
        HybridLoader.prototype.generateQueue = function () {
            ...
            var availableStorageCapacityPercent = this.getAvailableStorageCapacityPercent();
            for (var _i = 0, _a = generateQueue(this.lastRequestedSegment, this.playback, this.config, this.p2pLoaders.currentLoader, availableStorageCapacityPercent); _i < _a.length; _i++) {
                var item = _a[_i];
        ...
        HybridLoader.prototype.sendBroadcastAnnouncement = function (sendEmptySegmentsAnnouncement) {
            if (sendEmptySegmentsAnnouncement === void 0) {
                sendEmptySegmentsAnnouncement = false;
            }
    ...
    var SegmentMemoryStorage = /** @class */ (function () {
        ...
        SegmentMemoryStorage.prototype.getUsage = function () {
            ...
            for (var _i = 0, _a = this.cache.values(); _i < _a.length; _i++) {
                var _b = _a[_i], endTime = _b.endTime, data = _b.data;
        ...
        SegmentMemoryStorage.prototype.getStoredSegmentIds = function (_swarmId, streamId) {
            var externalIds = [];
            for (var _i = 0, _a = this.cache.values(); _i < _a.length; _i++) {
                var _b = _a[_i], segmentId = _b.segmentId, streamCacheId = _b.streamId;
        ...
        SegmentMemoryStorage.prototype.clear = function (isLiveStream, newSegmentSize) {
            ...
            for (var _i = 0, sortedCache_1 = sortedCache; _i < sortedCache_1.length; _i++) {
                var segmentData = sortedCache_1[_i];
        ...
        */
        Core.prototype.updateStream = function (streamRuntimeId, addSegments, removeSegmentIds) {
            ...
            if (!stream)
                return;
            if (addSegments)
                for (var _i = 0, addSegments_1 = addSegments; _i < addSegments_1.length; _i++) {
                    var segment = addSegments_1[_i];
            ...
            if (removeSegmentIds)
                for (var _a = 0, removeSegmentIds_1 = removeSegmentIds; _a < removeSegmentIds_1.length; _a++) {
                    var id = removeSegmentIds_1[_a];
    ...
    var SegmentManager = /** @class */ (function () {
        ...
        SegmentManager.prototype.processMainManifest = function (data) {
            ...
            for (var _a = 0, audioTracks_1 = audioTracks; _a < audioTracks_1.length; _a++) {
                var track = audioTracks_1[_a];
        ...
        SegmentManager.prototype.updatePlaylist = function (data) {
            ...
            fragments.forEach(function (fragment, index) {
                ...
                var start = fragByteRange[0], end = fragByteRange[1];
                var byteRange = getByteRange(start, end !== void 0 ? end - 1 : void 0);
